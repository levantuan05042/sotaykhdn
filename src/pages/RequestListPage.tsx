...
const RequestListPage: React.FC = () => {
  ...
  // Gọi API lấy danh sách yêu cầu dựa vào bộ lọc và enrichment tên người dùng
  const fetchData = async () => {
    ...
    try {
      ...
      // Đọc thông tin user từ sessionStorage giống trang ProductGroupPage
      ...
      try {
        ...
        console.error('Lỗi khi parse danh sách user từ sessionStorage:', e);
      }

      // Bổ sung thông tin createdByFullName và approvedBy
