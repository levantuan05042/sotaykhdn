  ...
  return (
    <div className="pageWrapper">
      ...
      <ActionConfirmModal
        ...
        desc={confirmAction === 'DRAFT' || confirmAction === 'NEEDS_REVISION' ? 'Bạn có chắc chắn muốn lưu bản nháp danh mục sản phẩm không?' : 'Bạn có chắc chắn muốn gửi phê duyệt danh mục sản phẩm không?'}
